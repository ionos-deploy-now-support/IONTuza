<x-app-layout>
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <a href="{{ route('admin.magazine.create') }}" class="btn btn-primary mb-4">Create Magazine</a>
                ...
                <tbody>
                    @foreach ($magazines as $index => $magazine)
                        <tr>
                            ...
                            <td>
                                <button data-modal-target="authentication-modal-{{ $index }}" data-modal-toggle="authentication-modal-{{ $index }}" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                                    Download
                                </button>
                                <!-- Modal -->
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5">
                                                <form class="space-y-4" action="{{ route('admin.download.link', $magazine) }}" method="POST">
                                                    ...
                                                    <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send Download Link</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <td>
                                <a href="{{ route('admin.magazine.edit', $magazine) }}" class="btn btn-primary">Update</a>
