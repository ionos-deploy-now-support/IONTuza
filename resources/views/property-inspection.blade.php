            ...
            <div class="container">
                <div class="container">
                   <div class="container mt-5  rental-collection p-5">
                           <h2 class="font-weight-bold pb-5 pt-5">{{ __('rental-collection.inspection_head') }}</h2>
                        <div class="row">
                            <div class="col-md-8 content">
                                <p>{{ __('rental-collection.inspection_description') }}</p>
                                <a   href="{{ route('property-inspection-contact') }}" class="btn btn-custom">{{ __('rental-collection.inspection_button_text') }}</a>
                            </div>
                            <div class="col-md-4 image">
                                <img src="{{ asset('assets/images/property-inspection.jpg') }}" alt="Image">
                            </div>
                        </div>
                    </div>
